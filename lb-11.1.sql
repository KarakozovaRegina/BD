...
---  ORDERS
---
INSERT INTO ORDERS VALUES (1,'2007-12-17',2117,106,'REI','2A44L',7,31500.00);
INSERT INTO ORDERS VALUES (2,'2008-01-11',2111,105,'ACI','41003',35,3745.00);
--INSERT INTO ORDERS VALUES (3,'2008-01-03',2111,106,'FEA','114',6,1458.00);
--INSERT INTO ORDERS VALUES (4,'2008-02-10',2118,108,'QSA','XK47',4,1420.00);
INSERT INTO ORDERS VALUES (5,'2007-10-12',2102,101,'ACI','41004',34,3978.00);
INSERT INTO ORDERS VALUES (6,'2008-01-30',2107,110,'ACI','4100Z',9,22500.00);
INSERT INTO ORDERS VALUES (7,'2008-02-02',2112,108,'REI','2A44R',10,45000.00);
INSERT INTO ORDERS VALUES (8,'2007-12-17',2103,105,'ACI','41004',28,3276.00);
INSERT INTO ORDERS VALUES (9,'2008-01-14',2118,108,'BIC','41003',1,652.00);
--INSERT INTO ORDERS VALUES (10,'2008-02-23',2108,109,'FEA','112',10,1480.00);
INSERT INTO ORDERS VALUES (11,'2008-01-08',2124,107,'BIC','41003',1,652.00);
INSERT INTO ORDERS VALUES (12,'2007-12-27',2103,105,'ACI','41004',6,702.00);
--INSERT INTO ORDERS VALUES (13,'2008-01-20',2114,108,'QSA','XK47',20,7100.00);
--INSERT INTO ORDERS VALUES (14,'2008-02-24',2124,107,'FEA','114',10,2430.00);
INSERT INTO ORDERS VALUES (15,'2007-10-12',2114,102,'ACI','4100Z',6,15000.00);
INSERT INTO ORDERS VALUES (16,'2008-01-22',2103,105,'ACI','41002',54,4104.00);
--INSERT INTO ORDERS VALUES (17,'2008-01-08',2112,108,'IMM','773C',3,2925.00);
--INSERT INTO ORDERS VALUES (18,'2008-03-02',2109,107,'IMM','775C',22,31350.00);
INSERT INTO ORDERS VALUES (19,'2008-01-29',2107,110,'REI','2A45C',8,632.00);
INSERT INTO ORDERS VALUES (20,'2007-11-04',2118,108,'ACI','41002',10,760.00);
INSERT INTO ORDERS VALUES (21,'2007-10-12',2111,103,'REI','2A44G',6,2100.00);
INSERT INTO ORDERS VALUES (22,'2008-02-15',2108,101,'ACI','4100X',6,150.00);
--INSERT INTO ORDERS VALUES (23,'2008-02-10',2120,102,'IMM','779C',2,3750.00);
INSERT INTO ORDERS VALUES (24,'2007-01-04',2106,102,'REI','2A45C',24,1896.00);
--INSERT INTO ORDERS VALUES (25,'2008-02-27',2106,102,'QSA','XK47',6,2130.00);
--INSERT INTO ORDERS VALUES (26,'2008-01-25',2108,109,'IMM','779C',3,5625.00);
--INSERT INTO ORDERS VALUES (27,'2008-02-10',2118,108,'QSA','XK47',2,776.00);
--INSERT INTO ORDERS VALUES (28,'2007-12-31',2103,105,'ACI','4100Y',11,27500.00);
--INSERT INTO ORDERS VALUES (29,'2008-02-18',2111,103,'ACI','4100X',24,600.00);
INSERT INTO ORDERS VALUES (30,'2008-02-20',2113,101,'REI','2A44R',5,22500.00);
...
SELECT * FROM SALESREPS WHERE SALESREPS.MANAGER IS NULL;
SELECT * from OFFICES WHERE REGION LIKE 'East%';
--3.1	Выбрать заказы, сделанные в определенный период.--
SELECT * FROM ORDERS WHERE ORDER_DATE BETWEEN '2007-12-17' AND '2008-01-30';

--3.2	Выбрать сотрудника, у которого нет менеджера (самого главного)--
SELECT * FROM SALESREPS WHERE SALESREPS.MANAGER IS NULL;
